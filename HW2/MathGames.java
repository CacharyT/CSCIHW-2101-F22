...
public class MathGames {
    ...
    // 2. Create a method that will calcuate my grade in the class. You can use the grade range as follows
        ...
        public static String grade(double grade){
            ...
            //Cast the grade first to round up
            int newGrade = (int) Math.ceil(grade);
    ...
    //Tip Method
    public static String tip(double totalBill, int peopleCount, double tipPercent){

        double tipAmount = totalBill * (tipPercent/100);
        double totalAmount = totalBill + tipAmount;
        double totalTipPerPerson = tipAmount / peopleCount;
        int totalBillPerPerson = (int) Math.ceil(totalAmount/peopleCount);
        String outPut = "Total Bill with Tip: $" + totalAmount + "\nTotal tip Per Person: $" + totalTipPerPerson 
        + "\nTotal Bill Per Person with Tip: $" + totalBillPerPerson;
    ...
    // you do not need this main if you want to make a tester class
     public static void main(String[] args){
        System.out.println(pythagorean(2, 2));
        System.out.println(grade(79.1));
        System.out.println(tip(200, 5, 15));
    }
